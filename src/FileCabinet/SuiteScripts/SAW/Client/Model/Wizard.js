...
Wizard.prototype.loadOutsideCemetery = function(id, callback) {
    this.db.loadEntity({
        columns: this.entity.outsideCemetery.columns,
        id,
        type: DEF.RECORD_TYPE.outsideCemetery
    }, function(data) {
        if (data.success)
